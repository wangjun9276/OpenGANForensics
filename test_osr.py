...
def main_worker(**kwargs):
    ...
    known_data = Custom_train_loader(args.data_path, './data_ours/labels_known_list.txt',
    ...
    unnknown_data = Custom_train_loader(args.data_path, './data_ours/labels_uknow_list.txt',
                                     img_size=args.img_size,
                                     binary=False,
